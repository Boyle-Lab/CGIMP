# How to contribute to CGIMP
----
**First and foremost:** by contributing in this project, you agree to abide by
the Contributor Covenant [code of conduct](https://github.com/Boyle-Lab/CGIMP/CODE_OF_CONDUCT.md)
...
* Read the [documentation](https://cgimp.readthedocs.io/en/latest/) on the project
* Search the GitHub [Issues](https://github.com/Boyle-Lab/CGIMP/issues) for this project to see if this question has already been addressed
* If neither of these avenues answer your question, please feel free to create
a new [issue](https://github.com/Boyle-Lab/CGIMP/issues) that has a 
...
* Ensure the bug has not been already reported:
    * Search the GitHub [Issues](https://github.com/Boyle-Lab/CGIMP/issues) for this project
...
git clone git@github.com:your-username/CGIMP.git

```

Commit your changes to your fork, and submit a [Pull Request](https://github.com/Boyle-Lab/CGIMP/pulls)
